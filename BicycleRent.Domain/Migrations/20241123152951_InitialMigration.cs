    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bicycles", x => x.SerialNumber);
                    table.ForeignKey(
                        name: "FK_Bicycles_BicycleTypes_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BicycleSerialNumber = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rentals_Bicycles_BicycleSerialNumber",
                        column: x => x.BicycleSerialNumber,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rentals_BicycleSerialNumber",
                table: "Rentals",
                column: "BicycleSerialNumber");
